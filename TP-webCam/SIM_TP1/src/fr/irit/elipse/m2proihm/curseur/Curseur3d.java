...
public class Curseur3d
{
	...
	public Curseur3d ()
		...
		try {
			s1 = loader.load("U:/EclipseProjects/SIM_TP1/src/fr/irit/elipse/m2proihm/curseur/hand1.obj");
			}
		...
		try {
			s2 = loader.load("U:/EclipseProjects/SIM_TP1/src/fr/irit/elipse/m2proihm/curseur/hand3.obj");
			}
			catch (FileNotFoundException e)
				{
				System.err.println(e);
